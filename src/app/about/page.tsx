...
const timelineEvents = [
  // ... (rest remains the same)
  {
    ...
    description:
      "Built a strong foundation in Computer Science and Data Structures.",
    year: "Year 1",
  },
  {
    icon: Code2,
    ...
    description:
      "Mastered React, Next.js, and Node.js. Built multiple production-ready apps.",
    year: "Year 2",
  },
  {
    icon: Server,
    ...
    description:
      "Designed secure REST APIs, implemented JWT authentication, and scaled databases.",
    year: "Year 3",
  },
  {
    icon: BrainCircuit,
    ...
    description:
      "Integrated AI models into web products for enhanced user experiences.",
    year: "Year 3+",
  },
  {
    icon: TrendingUp,
    ...
    description:
      "Continuously strengthening full-stack development expertise through real-world projects, backend architecture practice, and modern frontend frameworks.",
    year: "Ongoing",
  },
];
          ...
          >
            ...
            <div className="space-y-4 text-center md:text-left flex-1 max-w-xl">
              ...
              <p className="text-neutral-400 text-lg leading-relaxed">
                ...
                intuitive user interfaces. I engineer solutions that blend
              ...
              {timelineEvents.map((event, index) => (
                ...
                >
                  ...
                  <div className="glass p-6 rounded-2xl border-l-[3px] border-l-blue-500 hover:bg-blue-500/5 transition-colors group">
                    ...
                    <span className="text-xs font-semibold text-purple-400 tracking-wider uppercase mb-3 block">
                      {event.year}
                    </span>
              ...
              <div className="glass p-8 rounded-3xl relative overflow-hidden group">
                ...
                <div className="space-y-6 text-neutral-300 relative z-10">
                  <p className="leading-relaxed">
                    Currently in my 3rd year of Computer Science Engineering, my
                    passion lies heavily in{" "}
                    <strong className="text-white">backend architecture</strong>{" "}
                    and{" "}
                    <strong className="text-white">real-time systems</strong>.
                  </p>
                  <p className="leading-relaxed">
                    I enjoy tackling complex problems, translating them into
                    clean code, and optimizing performance. With over{" "}
                    <strong className="text-white">
                      200 LeetCode problems
                    </strong>{" "}
                    solved, I maintain a strong foundation in Data Structures
                    and Algorithms.
                  </p>
                  <p className="leading-relaxed">
                    My recent work spans across building robust APIs, securing
                    applications with JWTs, and exploring ways to seamlessly
                    integrate AI features into modern web platforms.
                  </p>
                </div>
              </div>
