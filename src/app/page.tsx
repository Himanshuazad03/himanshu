...
const featuredProjects = [
  {
    ...
    title: "InterviewIQ",
    description:
      "AI-powered mock interview platform that generates tailored questions, evaluates responses, and provides detailed performance analytics with actionable feedback.",
    tech: ["Next.js", "TypeScript", "PostgreSQL", "Prisma", "Clerk", "Gemini"],
  ...
  },
  {
    ...
    title: "BulletCraft",
    description:
      "AI resume and LinkedIn content generator that transforms raw project descriptions into ATS-optimized resume bullet points and professional social posts.",
    tech: [
      "Next.js",
      "TypeScript",
      "Tailwind",
    ...
    <PageTransition>
      <div className="flex flex-col items-center justify-center min-h-[90vh] w-full mt-16 space-y-40 mb-28 px-4 lg:px-16 overflow-hidden">
        ...
        <section className="relative flex flex-col items-center text-center space-y-10 w-full max-w-7xl z-10">
          ...
          >
            <Typewriter
              text="Next.js | MERN | AI Integration | Real-Time Systems"
              delay={1}
            />
          </motion.p>
          ...
          >
            <Link href="/projects" className="w-full sm:w-auto">
              <Button
                size="lg"
                className="w-full sm:w-auto rounded-full group relative overflow-hidden bg-yellow-300 text-black hover:bg-yellow-400"
              >
            ...
            >
              <Button
                size="lg"
                variant="outline"
                className="w-full rounded-full border-slate-700 text-slate-300 bg-slate-100 text-slate-800
          ...
          >
            ...
            <div className="space-y-6">
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight">
                Architecting <span className="text-gradient">Real-World</span>{" "}
                Solutions
              </h2>
              <p className="text-neutral-400 text-lg leading-relaxed">
                I am a full-stack developer obsessed with scalable systems and
                AI integration. Currently pursuing my Computer Science degree, I
                specialize in the Next.js and MERN ecosystems.
              </p>
              ...
              <div className="pt-4">
                <Link href="/about">
                  <Button
                    variant="outline"
                    className="rounded-full glass hover:bg-white/10 group"
                  >
                    Learn More About Me
        ...
        <section className="w-full max-w-7xl z-10 relative space-y-12 px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {techStack.map((tech, i) => (
              ...
              >
                <div
                  className={`absolute inset-0 opacity-0 group-hover:opacity-10 bg-gradient-to-br ${tech.color} transition-opacity duration-500 rounded-2xl blur-md`}
                />
                <div
                  className={`p-4 rounded-xl bg-white/5 border border-white/10 group-hover:border-white/30 transition-colors relative z-10`}
                >
                  <img
                    src={tech.logo}
                    alt={tech.name}
                    className="w-8 h-8 text-neutral-300 group-hover:text-white transition-colors drop-shadow-[0_0_10px_rgba(255,255,255,0.2)] group-hover:drop-shadow-[0_0_15px_rgba(255,255,255,0.8)]"
                  />
                </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-4">
            ...
            >
              <Link href="/projects">
                <Button
                  variant="ghost"
                  className="rounded-full group hover:bg-white/5"
                >
                  View All Projects
                  <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
                </Button>
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="flex flex-wrap gap-2 mb-7">
                    {project.tech.map((t) => (
                      <span
                        key={t}
                        className="text-m px-2 py-1 rounded-md bg-white/5 border border-white/10 text-neutral-300"
                      >
                        {t}
                      </span>
                    ))}
          ...
          >
            ...
            <div className="relative z-10 space-y-6 max-w-2xl mx-auto">
              ...
              <p className="text-lg text-neutral-300">
                Currently open to internships and full-stack software
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
                <Link href="/contact" className="w-full sm:w-auto">
                  <Button
                    size="lg"
                    className="w-full sm:w-auto rounded-full group relative overflow-hidden bg-yellow-300 text-black hover:bg-yellow-400 shadow-[0_0_30px_-5px_rgba(59,130,246,0.5)] cursor-pointer"
                  >
